...
<body>
    <!-- Top Navbar -->
    <nav class="navbar navbar-dark fixed-top p-0 shadow" style="background-color: #17a2b8;">
        <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="adminDashboard.php">SkillUp<small class="text-white"> - Admin Dashboard</small></a>
    </nav>
